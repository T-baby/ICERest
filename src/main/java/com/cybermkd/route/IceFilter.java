 ...
 */
public final class IceFilter implements Filter {
    ...
    public void init(FilterConfig filterConfig) throws ServletException {
        ...
        try {
            ...
            if (icerest.init(config, filterConfig.getServletContext()) == false)
                throw new RuntimeException("ICEREST init error!");
            iceIniter = icerest.getRestIniter();
            handler = iceIniter.getHandler();
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain) throws IOException, ServletException {
        ...
        HttpRequest request = new HttpRequest((HttpServletRequest) servletRequest, iceIniter.getServletContext());
